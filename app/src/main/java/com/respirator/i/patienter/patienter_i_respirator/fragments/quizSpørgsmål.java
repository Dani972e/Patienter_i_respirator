...
public class quizSpørgsmål {
    ...
    public String korrektesvar[] = {"ca. 5.5 millioner", "København", "Tyskland og Sverige", "50", "50", "Merkur og Venus", "8", "Ulve"};
    ...
    public String getsvar1(int a){
        System.out.println("svar: " + a + " længde: "+minesvar.length + " "+minesvar[a].length);
